...
int CurrentZAxisStep;
int CurrentRxAxisStep;
int CurrentRyAxisStep;
int CurrentRzAxisStep;
//int CurrentThrottleAxisStep;
//int CurrentRudderAxisStep;
...
int CurrentZAxisStep = 0;
int CurrentRxAxisStep = 0;
int CurrentRyAxisStep = 0;
int CurrentRzAxisStep = 0;
//int CurrentThrottleAxisStep = 0;
//int CurrentRudderAxisStep = 0;
